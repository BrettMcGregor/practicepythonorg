...
are going to approximate this clicking simply by asking the user for a coordinate of where
...
Bonus:
    ...
    For the “standard” exercise, don’t worry about “ending” the game - no need to keep track
    of how many squares are full. In a bonus version, keep track of how many squares are
...
print("\nEnter row and column to place your move into that cell")
